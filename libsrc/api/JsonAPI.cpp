	...
	, _image_stream_timeout(0)
{
	...
	connect(this, &JsonAPI::pushReq, _hyperion, &Hyperion::hyperionStateChanged);
...
void JsonAPI::setImage(int priority, const Image<ColorRgb> & image, int duration_ms)
{
