...
GIT_REPO_URL="https://github.com/brindosch/hyperion.ngBeta.git"
# cmake build type
BUILD_TYPE="Release"
...
git clone --recursive -q -b rework $GIT_REPO_URL $SCRIPT_PATH/hyperion || { echo "---> Failed to download Hyperion source code! Abort"; exit 1; }
