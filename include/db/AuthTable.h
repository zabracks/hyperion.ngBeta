...
public:
	...
	///
	inline const bool createUser(const QString& user, const QString& pw)
	{
		// new salt
	...
	/// @return     true on success else false
	///
	inline const bool userExist(const QString& user)
	{
		VectorPair cond;
		cond.append(CPair("user",user));
	...
	/// @return       True on success else false
	///
	inline const bool isUserAuthorized(const QString& user, const QString& pw)
	{
	...
	/// @return     true on success else false
	///
	inline const bool tokenExist(const QString& token)
	{
		QVariantMap map;
		map["last_use"] = QDateTime::currentDateTimeUtc().toString(Qt::ISODate);
	...
	/// @return     true on success else false
	///
	inline const bool createToken(const QString& token, const QString& comment, const QString& id)
	{
		QVariantMap map;
		map["comment"] = comment;
	...
	/// @return     true on success else false
	///
	inline const bool deleteToken(const QString& id)
	{
		VectorPair cond;
